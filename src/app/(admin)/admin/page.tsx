                ...
                {usageDays.map((day) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div
                        className="w-full rounded-t-md bg-emerald-500/80 hover:bg-emerald-600 transition-colors min-h-[4px]"
            ...
            <CardHeader className="pb-3">
              <div className="flex items-center justify-between">
                ...
                <Button
                  ...
                  className="text-emerald-600 hover:text-emerald-700 text-xs gap-1"
                >
                  عرض الكل
