...
export default function DashboardPage() {
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      try {
        ...
        const [patientsRes, conversationsRes] = await Promise.all([
  ...
  const chartData = [
    ...
    { name: 'أحد', visits: 6, plans: 3 },
    { name: 'إثنين', visits: 3, plans: 1 },
    { name: 'ثلاثاء', visits: 7, plans: 4 },
    { name: 'أربعاء', visits: 5, plans: 2 },
    { name: 'خميس', visits: 8, plans: 5 },
    { name: 'جمعة', visits: 2, plans: 1 },
  ];
